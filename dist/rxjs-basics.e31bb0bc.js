...
var mapResponse = /*@__PURE__*/(0, _map.map)(function (x, index) {
  return x.response;
});
...
},{"../internal/observable/dom/ajax":"node_modules/rxjs/_esm5/internal/observable/dom/ajax.js","../internal/observable/dom/AjaxObservable":"node_modules/rxjs/_esm5/internal/observable/dom/AjaxObservable.js"}],"node_modules/rxjs/_esm5/internal/operators/audit.js":[function(require,module,exports) {
"use strict";
...
var pollingStatus = document.getElementById("polling-status");
var dogImage = document.getElementById("dog");
var scrollBar = document.getElementById("scroll-bar");
var bg = document.getElementById('bg');

var calculateScrollPercent = function calculateScrollPercent(element) {
...
var startClick$ = (0, _rxjs.fromEvent)(startButton, 'click');
var stopClick$ = (0, _rxjs.fromEvent)(stopButton, 'click');
var scroll$ = (0, _rxjs.fromEvent)(document, 'scroll');
var progress$ = scroll$.pipe((0, _operators.map)(function (_ref) {
  var target = _ref.target;
  return calculateScrollPercent(target.scrollingElement);
}), (0, _operators.tap)(function (percent) {
  scrollBar.style.width = "".concat(percent, "%");
  bg.style.backgroundPositionY = "".concat(percent / 5, "%");
})).subscribe(console.log);
startClick$.pipe((0, _operators.exhaustMap)(function () {
  return (0, _rxjs.timer)(0, 5000).pipe((0, _operators.tap)(function () {
    return pollingStatus.innerHTML = "Start";
  }), (0, _operators.switchMapTo)(_ajax.ajax.getJSON("https://random.dog/woof.json")), (0, _operators.takeUntil)(stopClick$), (0, _operators.finalize)(function () {
    return pollingStatus.innerHTML = "Stopped";
  }));
})).subscribe(function (dog) {
  return dogImage.src = dog.url;
});
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/ajax":"node_modules/rxjs/_esm5/ajax/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/rxjs-basics.e31bb0bc.js.map